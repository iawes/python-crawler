...
headers = {
    ...
    'cookie': 'v=A-hDV7YaH1zy-zPlrJ08dI4Kudf_EU2bLnQgj6IZNh1WBIbDSiEcq36F_HLx; historystock=000516; spversion=20130314'
}
...
for i in range(len(data)):
    ...
    try:
        ...
        for j in range(page):
            ...
            request =  urllib.request.Request(url=curl, headers=headers)
            response = urllib.request.urlopen(request)
